 // {id: 'snapshot-data', title: 'Snapshot Data', content: 'Markdown text', category: 'Market Data'}
        ...
        items: [
            {
                id: 'snapshot-data',
                title: 'Snapshot Data',
                content: 'Duis gravida semper enim id semper. Suspendisse iaculis, sapien at ullamcorper ultrices, velit urna interdum odio, eu egestas lorem arcu vitae nulla. Nulla hendrerit porttitor nulla sed congue. Donec nec enim ac velit mollis sollicitudin quis sed diam. Integer velit leo, sollicitudin quis blandit ut, luctus a eros. Pellentesque tincidunt aliquet lorem, ac egestas elit malesuada vel. Sed pharetra, neque id ullamcorper rhoncus, sem est tincidunt lorem, in bibendum erat nisl a nulla. Quisque vestibulum justo nibh, vel porta lacus accumsan vitae. In ut vehicula libero. Proin semper felis vel ipsum pulvinar, et sollicitudin odio aliquam. Mauris sit amet sem nunc. Nulla id blandit sapien, eget porttitor turpis. Fusce ac nunc sed erat ultricies euismod. Vestibulum commodo velit rhoncus, volutpat sapien non, placerat turpis.',
            },
            {
                id: 'historical-data',
