<template>
  <div>
    ...
    <section>
      ...
      <p>
        A working installation of Java is required to run the Client Portal API gateway. The minimum requirement is Java 8 update 192.
      </p>
    </section>
    <section>
    ...
    <section>
      <h3>Step five: Login & Authenticate</h3>
      <p>
        Once the gateway is running, you will need to authenticate the session. In order to do so, navigate to <a href="https://localhost:5000">https://localhost:5000</a> from your local network.
        You will need to provide the username and password. The message 'Client Login Succeeds' is displayed when the login is successful.
      </p>
      <p>
        <b>Note:</b> the port number, 5000, is set as default port for the gateway. To change it, update the conf.yaml file, found in the 'root' directory of the gateway.
      </p>
    </section>
  </div>
</template>
